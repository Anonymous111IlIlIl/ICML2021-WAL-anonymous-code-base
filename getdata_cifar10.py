...
class Cus_Dataset(data.Dataset):
    def __init__(self, mode, data_set, begin_ind, end_ind, begin_ind1=None, end_ind1=None, new_model=None):
        self.mode = mode
        ...
        if self.mode == 'train': #only used for training the weak annotator
            ...
            list_img_t = self.total_img[begin_ind1: end_ind1]
